...
public class ServerConcentrationSite {
    ...
    public static void main(String[] args) {
        ...
        ConcentrationSiteInterface ConcetrationSiteInter; // Interface to the ConcentrationSite
        ConcentrationSite Concetration_Site; // ConcentrationSite (service to be rendered)
        ...
        Concetration_Site = new ConcentrationSite(GeneralRepositoryStub); // Service is instantiated
        ConcetrationSiteInter = new ConcentrationSiteInterface(Concetration_Site); // Interface for the service is instantiated
        ...
        while (waitConnection) {
            try {
                ...
                cliProxy = new ConcentrationSiteClientProxy(sconi, ConcetrationSiteInter);
                cliProxy.start();
